...
let users = [
    ...
    },
    {
        'firstName': 'Arsen',
        'lastName': 'Tasha',
        'userImg': "img/arsen.jpg"
    },
    {
        'firstName': 'Delil',
        'lastName': 'Duro',
        'userImg': "img/delil.jpg"
    }];
let userNameArr = [];
let userImgArr = [];
...
function selectAvatar(i){
    ...
    if (userNameArr.includes(firstName)) {
        userNameArr = userNameArr.filter(a => a !=firstName);
        userImgArr = userImgArr.filter(a => a !=userImg);  
    }else {
       userNameArr.push(firstName);  
    ...
    document.getElementById('board').innerHTML += `
        <div class="popup">
            <div class="taskTopline">
                ...
                <div>
                    <img class="boardBtn" onclick="closePopup()" src="img/cancel-48.png">
                    <img class="boardBtn" onclick="deleteBoardTask(${board[i]['id']})" src="img/delete-48.png">
                </div>
            </div>
